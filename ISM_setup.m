...
SetupStruc.mic_pos = [x+0.0000 y+0.1225 z+0.4280;   % 0
                      ...
                      x+0.1225 y+0.0000 z+0.4370;   % 2
                      x+0.0866 y-0.0866 z+0.4430;   % 3
                      x+0.0000 y-0.1225 z+0.4460;   % 4
                      x-0.0866 y-0.0866 z+0.4430;   % 5
                      x-0.1225 y+0.0000 z+0.4370;   % 6
                      x-0.0866 y+0.0866 z+0.4310;   % 7
                      x+0.0000 y+0.1225 z+0.1900;   % 8
                      x+0.0866 y+0.0866 z+0.1900;   % 9
                      x+0.1225 y+0.0000 z+0.1990;   % 10
                      x+0.0866 y-0.0866 z+0.2100;   % 11
                      x+0.0000 y-0.1225 z+0.2100;   % 12
                      x-0.0866 y-0.0866 z+0.2000;   % 13
                      x-0.1225 y+0.0000 z+0.1990;   % 14
                      x-0.0866 y+0.0866 z+0.1900];  % 15
